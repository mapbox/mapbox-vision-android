...
internal interface SurfaceVideoRecorder : VideoRecorder {
    ...
    class MediaCodecPersistentSurfaceImpl(
            ...
            private val recordingListener: VideoRecordingListener,
        ...
        override fun stopRecording() {
            ...
            if (filePath != null && !filePath.isBlank()) {
                recordingListener.onVideoRecorded(filePath)
            }
        ...
        private fun updateNextBufferFile() {
            if (nextVideoFilePath.isNullOrEmpty()) {
                nextVideoFilePath = FileUtils.getFilePath(buffersDir, BUFFER_FILE_NAMES[currentBufferNum])
