package com.mapbox.vision.video.videosource.media
...
class FileVideoSource(
...
) : VideoSource, VideoSource.WithProgress {
    ...
    override fun getSourceWidth() = width

    override fun getSourceHeight() = height
        ...
        try {
            try {
                ...
                responseHandler.post {
                    ...
                    yuvToRgbIntrinsic.setInput(sourceAllocation)
                    yuvToRgbIntrinsic.forEach(destinationAllocation)
