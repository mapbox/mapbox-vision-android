...
internal class SensorsRequestsManager(application: Application) : SensorEventListener {
    ...
    private val userAccelerationWidthGravity = FloatArray(3)
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        synchronized(this) {
            ...
            when (event.sensor.type) {
                TYPE_ACCELEROMETER -> {
                    userAccelerationWidthGravity[0] = event.values[0]
                    userAccelerationWidthGravity[1] = event.values[1]
                    userAccelerationWidthGravity[2] = event.values[2]
                }
                TYPE_MAGNETIC_FIELD -> {
        ...
        synchronized(this) {
            ...
            listener.onDeviceMotionDataReady(
                DeviceMotionData(
                    ...
                    gravity = gravity,
                    userAcceleration = userAccelerationWidthGravity
